...
- [Instructions](#instructions)
  ...
  -  [STEP 4: Visualization using boardplots]
...
**Board Plots:** Board Plots can be generated by using the board plot function provided in CRISPR-Millipede. Board Plots require the millipede table, presort, and wt editing frequencies.
