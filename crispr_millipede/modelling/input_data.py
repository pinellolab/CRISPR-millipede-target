"""
Data loading and input preparation for CRISPR-Millipede.

This module handles loading raw encoding data, validating file structures,
computing read statistics, and preparing input data for Millipede model specifications.

Key Classes:
- MillipedeInputDataLoader: Core loader for raw experimental data files
- MillipedeInputDataExperimentalGroup: Processes input data for model specifications
"""
